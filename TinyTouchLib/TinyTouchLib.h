...
#define tt_refpin 2		// Pin 7 - Use PB2 as reference pin
#define tt_refadc 1		// Pin 7 - Use ADC1 as reference ADC input
#define tt_sensepin 3	// Pin 2 - Use PB3 as sense pin
#define tt_senseadc 3	// Pin 2 - Use ADC3 as sense ADC input
// Note LED on PB4		// Pin 4 - Can be changed to suit
